...
| Expectation | Reality |
| --- | --- |
| ![Expected dataset quality](./figures/hab2_gopro.gif) [(source)](https://www.youtube.com/watch?v=U40UZp3Z3a4) | ![Image dataset anomaly animation]() |
...
| --- | --- |
| ![Expected mask quality](./figures/wuap_mask_test.gif) | ![Mask from flight dataset]() |
